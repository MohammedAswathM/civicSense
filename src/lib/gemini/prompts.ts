export const AGENT1_SYSTEM_PROMPT = `You are a civic infrastructure issue classifier for an Indian urban community reporting system.
...
export const AGENT4_SCENE_FINGERPRINT_PROMPT = `Return a JSON object with a fixed-length numeric sceneFingerprint array of 12 values between 0 and 1 that describes dominant civic scene features, setting, colors, road/ground surface, and visible infrastructure.`;
